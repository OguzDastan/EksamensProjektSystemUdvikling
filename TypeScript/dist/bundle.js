...
var baseUri = "https://voresvejrstation.azurewebsites.net/api/WeatherDatas";
var buttonElement = document.getElementById("GetAll");
buttonElement.addEventListener("click", ShowAllweatherdata);
var buttonElement_GetId = document.getElementById("GetId");
buttonElement_GetId.addEventListener("click", getId);
var outputElement = document.getElementById("output_1");
function recordToString(weatherdata) {
...
function ShowAllweatherdata() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(baseUri)
        ...
        var result = "<tr>";
        response.data.forEach(function (weatherdata) {
...
function add() {
    var addPrice = document.getElementById("Pris");
    var addGendstand = document.getElementById("temperature");
    var addpressure = document.getElementById("pressure");
    var mytime = "Auction";
    var myPrice = 0;
    var mytemperature = addGendstand.value;
    var mypressure = "../img/" + addpressure.value;
    var outputElement = document.getElementById("output_3");
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUri, { temperature: mytemperature, pressure: mypressure, price: myPrice, time: mytime })
        .then(function (response) {
...
function deleteweatherdata() {
    ...
    var inputElement = document.getElementById("sletId");
